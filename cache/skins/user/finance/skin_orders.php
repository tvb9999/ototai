...
//===========================================================================
// <rsf:cartSummary:desc::trigger:>
//===========================================================================
function cartSummary($itemCart="") {global $vsLang, $bw;
...
//===========================================================================
// <rsf:ItemList:desc::trigger:>
//===========================================================================
function ItemList($cart="",&$quantity=0) {global $vsLang, $bw, $vsPrint;
$arrayCart = array();
...
<table width="598px" border="0" cellspacing="0" cellpadding="0">
                            {$this->__foreach_loop__id_4e707e905aa8b($cart,$quantity)}
                              <tr>
...
//===========================================================================
function __foreach_loop__id_4e707e905aa8b($cart="",&$quantity=0)
{
global $vsLang, $bw, $vsPrint;
	...
	{
		$vsf_class = $vsf_count%2?'odd':'even';$amount = $amount + $value['total'];
...
//===========================================================================
// <rsf:orderCheckLogin:desc::trigger:>
//===========================================================================
function orderCheckLogin($message="") {global $vsLang,$bw,$vsPrint;
...
//===========================================================================
// <rsf:loadMessage:desc::trigger:>
//===========================================================================
function loadMessage() {global $bw;
