...
SWFUpload.prototype.getFlashVars = function () {
	...
	return ["movieName=", encodeURIComponent(this.movieName),
			...
			"&amp;fileId=", encodeURIComponent(this.settings.file_id),
...
SWFUpload.prototype.setFileId = function (fileId) {
	this.settings.file_id = fileId;
	this.callFlash("SetFileId", [fileId]);
};
