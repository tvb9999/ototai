<?php
class skin_pricecoffee extends skin_pages {
					...
					<tbody>
						...
						<foreach="$option['pageList'] as $obj">
							...
							<if="$vsSettings->getSystemKey($option['virtual'].'_hidePage_button',1, $option['virtual']) or $vsSettings->getSystemKey($option['virtual'].'_displayPage_button',1, $option['virtual']) or $vsSettings->getSystemKey($option['virtual'].'_deletePage_button',1, $option['virtual'])">
								...
								<if=" $option['upload'] ">
									<td>
									<a href="javascript:;" onclick="vsf.popupGet('gallerys/display-album-tab/pages/{$obj->getId()}&albumCode=image','files')" class="ui-state-default ui-corner-all ui-state-focus">
		...
		$BWHTML = <<<EOF
				<script type="text/javascript">
					...
					function catView(){					
						...
						vsf.get('pricecoffee/displayCatMPageList/'+cat.substr(1)+'/{$option['virtual']}/','mainPageContainer');
					}
				</script>
			...
			<div id="page_tabs" class="ui-tabs ui-widget ui-widget-content ui-corner-all-top">
				<ul id="tabs_nav" class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-corner-all-inner">
				 	<li class="ui-state-default ui-corner-top ui-tabs-selected ui-state-active">
			        	<a href="{$bw->base_url}pricecoffee/displayMPages/{$module}/&ajax=1">
			    ...
			    <form id="editPageForm" method="post">
					<table cellpadding="1" cellspacing="1" border="0" class="ui-dialog-content ui-widget-content" style="width:100%;">
		        		...
		        		<tr class='smalltitle'>
		            		...
		            		<td colspan="2" height="15">
		            			<input id="pageIntro" name="pageIntro" value="{$obj->getIntro()}" type="text" style="width:105px;margin-right:50px;">
		        			</td>
		        		</tr>
		        		<tr class='smalltitle'>
		        			<td >
		            		...
		            		<td colspan="2" height="15">
		            			<input id="pagePostDate" name="pagePostDate" value="{$obj->getPostDate('SHORT')}" type="text" style="width:105px;margin-right:50px;">
		        			</td>
		        		</tr>
					...
					<input type="hidden"  name="pageStatus"  value="1"/>	
				</form>
			</div>
			<div id="result"></div>
			<script type="text/javascript">
