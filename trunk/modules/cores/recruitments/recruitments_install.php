...
class recruitments_install {
	public $query = "";
	public $version = "3.3.4.1";
	public $build = "628";
	public $tableName = "recruitment";
	public $moduleTitle = "recruitments";
	function Install() {
		...
		$this->query[] = "
			CREATE TABLE IF NOT EXISTS `".SQL_PREFIX."{$this->tableName}` (
			  ...
			  `{$this->tableName}Begin` int(11) NOT NULL,
			  `{$this->tableName}End` int(11) NOT NULL,
